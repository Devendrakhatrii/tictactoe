...
/**
 * @brief This file is related with coded of tictactoe game.
 * @file tictactoe.h
 * @see Tictactoe()
 */
int Tictactoe()
...
///@brief to choose the category of the game-------------------------------------------------------------
void category()
{
    system("cls");
    printf("\n\n");
...
///@brief single user human and computer-------------------------------------------------------------------------------------------------------------
void singlePlayer()
{
    char winner = ' ';
    char response;
...
///@brief playing 2 peron with math problems----------------------------------------------------------------------------------------------------
void multiPlayer()
{
    char enterNames;
    int xo;
    ...
    ///@brief Ask if player wants to give names---------------------------------------------------------------------------------------------------
    printf("\n");
...
renamePlayer:
    ...
    do
    {
        ...
        ///@brief if no one is the winner and space is left then player one making move----------------------------

        ///@brief if player 1 plays first----------------------------------------------------
        if (xo == 1)
        {
            ...
            while (humanWinner == ' ' && checkFreeSpaces() != 0)
            {
                ...
                ///@brief if the name is given by the players
        ...
        ///@brief if player 2 wants to play first
        else
        {
...
///@brief single player move against computer
void playerMove()
{
...
///@brief player one move in multiPlayer
void player1Move()
{
...
///@brief player 2 move in multi player
void player2Move()
{
...
///@brief for printing the board every time the users input their move in multi player
void printBoard()
{
...
///@brief for resetting the board for new game
void resetBoard()
{
    int i, j;
    for (i = 0; i < 3; i++)
...
///@brief checking spaces if no space left and no one wins
int checkFreeSpaces()
{
...
///@brief checking if anyone won the game
char checkWinner()
{
    int i;
...
///@brief Random move by the computer
void computerMove()
{

    ///@brief creates a seed based on current time
...
///@brief winner from multi player
void winnerFrom2(char humanWinner)
{
...
///@brief function creating random math problem

int problem()
{
    int a, b, answer;

    ///@brief Generate two random numbers between 1 and 10
    ...
    ///@brief Read the user's answer
    scanf("%d", &answer);

    ///@brief Check if the answer is correct for subtraction
    ...
    {
        ///@brief Check if the answer is correct for multiplication
        if (answer == a * b)
        {
            return 1;
        }
    ...
    {
        ///@brief Check if the answer is correct for division
        /// @note only integer value is considered  as answer
        if (answer == a / b)
        {
            return 1;
        }
    ...
    {
        ///@brief Check if the answer is correct for addition
        if (answer == a + b)
        {
            return 1;
        }
